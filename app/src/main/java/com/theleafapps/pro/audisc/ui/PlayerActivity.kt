...
class PlayerActivity : AppCompatActivity(), ServiceConnection, MediaPlayer.OnCompletionListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.favouriteBtnPA.setOnClickListener {
            ...
            FavoriteActivity.favouritesChanged = true
        }
    }
    //Important Function
    private fun initializeLayout(){
        ...
        when(intent.getStringExtra("class")){
            ...
            "FavouriteAdapter"-> initServiceAndPlaylist(FavoriteActivity.favouriteSongs, shuffle = false)
            "MainActivity"-> initServiceAndPlaylist(MainActivity.MusicListMA, shuffle = true)
            "FavouriteShuffle"-> initServiceAndPlaylist(FavoriteActivity.favouriteSongs, shuffle = true)
